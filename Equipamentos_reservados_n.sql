...
/****** Object:  View [dbo].[Equipamentos_reservados_N]    Script Date: 29/01/2025 11:04:58 ******/
SET ANSI_NULLS ON
GO
...
FROM            dbo.TB02019 LEFT OUTER JOIN
						 ...
						 TB01110 ON TB01110_PRODUTO = TB01010_CODIGO AND TB01110_CODEMP = TB02018_CODEMP LEFT JOIN
						 ...
						 LEFT JOIN TB02130 ON TB02130_CODIGO = TB02115_CODIGO AND TB02130_TIPO = 'O' AND TB02130_STATUS = TB02115_STATUS AND TB02130_CODEMP in ('00','80')

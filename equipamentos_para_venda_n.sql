...
/****** Object:  View [dbo].[EQUIPAMENTOS_PARA_VENDA_N]    Script Date: 29/01/2025 11:04:19 ******/
SET ANSI_NULLS ON
GO
...
SELECT      dbo.TB02054.TB02054_CODEMP AS EMPRESA,
			...
			TB01110_VENDAPRO as VALORBASE,
			TB02054_FATOR AS FATOR,
			(TB01110_VENDAP * TB02054_FATOR) AS VALORFINAL,
...
FROM            dbo.TB02054 LEFT OUTER JOIN
						 ...
						 dbo.TB01110 ON dbo.TB01110.TB01110_PRODUTO = dbo.TB01010.TB01010_CODIGO AND TB01110_CODEMP = TB02054_CODEMP LEFT OUTER JOIN
						 ...
						 TB02130 ON TB02130_CODIGO = TB02115_CODIGO AND TB02130_TIPO = 'O' AND TB02130_STATUS = TB02115_STATUS LEFT JOIN
						 
						
						 TB02002 ON TB02002_CODIGO = (SELECT TOP 1 TB02055_CODIGO FROM TB02055 WHERE TB02055_NUMSERIE = TB02054_NUMSERIE AND TB02055_PRODUTO = TB02054_PRODUTO AND TB02055_TABELA = 'TB02002' AND TB02055_CODEMP=TB02054_CODEMP ORDER BY TB02055_CODIGO DESC) and TB02002_NESTOQUE = 'N'
